...
import Ormolu.Imports (GroupingStrategy (..), normalizeImports)
...
diffParseResult
  ...
  ParseResult
    ...
    diffCommentStream cstream0 cstream1
      <> diffHsModule
        hs0 {hsmodImports = concat . normalizeImports False NoGroupingStrategy $ hsmodImports hs0}
        hs1 {hsmodImports = concat . normalizeImports False NoGroupingStrategy $ hsmodImports hs1}
